...
public class Customer extends User{
    ...
    // Customer has one basket. Customer is the owner (foreign key will be added to Basket table.
    // All changes to customer are cascaded
    @OneToOne(mappedBy = "customer", cascade = CascadeType.ALL)
    private Basket basket;

    // Customer can have many ShopOrders, Customer is the owner (foreign key added)
